...
const {getAllAccountItems, createSingleItem, getSingleItem, updateSingleItem, deleteSingleItem, getExpiringItems} = require("../controllers/itemsController");
...
itemsRouter.get("/expiring/:days", authenticateToken, getExpiringItems);
